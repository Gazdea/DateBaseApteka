...
class MedicalRecordDAOTest {
    ...
    void getAllMedicalRecord() throws SQLException {
        ...
        assertNotNull(medicalRecordFromBD,"Should not be null");
        assertTrue(medicalRecordFromBD.stream().anyMatch(p-> p.getRecord_details().equals(medicalRecordBuilder.getRecord_details()) && p.getPatient_id() == medicalRecordBuilder.getPatient_id()), "Medical Record should match");
        assertTrue(medicalRecordFromBD.stream().anyMatch(p-> p.getRecord_details().equals(medicalRecordBuilder2.getRecord_details()) && p.getPatient_id() == medicalRecordBuilder2.getPatient_id()), "Medical Record should match");
